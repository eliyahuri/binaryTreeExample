...
export const examples: Record<`${Languages},${TreeKind}`, string> = {
  ...
  "Java,BST": `// Node class represents each node in the tree
class Node {
...
public class BinaryTree {
  ...
  "CSharp,BST": `// Node class represents each node
class Node {
...
class BinaryTree {
  ...
  "JavaScript,BST": `// Node class for tree nodes
class Node {
...
const t = new BinaryTree(1); t.insert(2); t.insert(3); // Example usage`,
  ...
  "TypeScript,BST": `// Node class for tree nodes
class Node {
    constructor(
...
const t = new BinaryTree(new Node(1)); t.insert(2); t.insert(3); // Example usage`,
  ...
  "Python,BST": `# Node class for tree nodes
class Node:
...
tree = BinaryTree(1); tree.insert(2); tree.insert(3)`,
  ...
  "Java,AVL": `// Node class represents each node in the AVL tree
class Node {
    int value; // Value of the node
...
public class AVLTree {
  ...
  "CSharp,AVL": `// Node class represents each node in the AVL tree
class Node {
    public int value; // Value of the node
...
class AVLTree {
  ...
  "JavaScript,AVL": `// Node class for AVL tree nodes
class Node {
    constructor(value) {
...
avl.insert(30); // Insert 30`,
  ...
  "TypeScript,AVL": `// Node class for AVL tree nodes
class Node {
...
avl.insert(30); // Insert 30`,
  ...
  "Python,AVL": `# Node class for AVL tree nodes
class Node:
    def __init__(self, value):
...
public class RedBlackTree {
  ...
  "CSharp,RBT": `// Enum for node color
enum Color {
    RED, // Red color
    BLACK // Black color
}
...
class RedBlackTree {
  ...
  "JavaScript,RBT": `const RED = true, BLACK = false; // Node colors
...
rbt.insert(30); // Insert 30`,
  ...
  "TypeScript,RBT": `type Color = "RED" | "BLACK"; // Node colors
...
rbt.insert(30); // Insert 30`,
  ...
  "Python,RBT": `RED, BLACK = True, False # Node colors
